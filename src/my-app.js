...
class MyApp extends PolymerElement {
    ...
    return html`
      ...
      <app-drawer-layout fullbleed="" narrow="{{narrow}}" style="background-color:#f1f1f1!important">
        ...
        <app-drawer id="drawer" slot="drawer" swipe-open="[[narrow]]" style="background-color:red">
          ...
          <a name="profile" href="[[rootPath]]profile">Users</a>
          <template is="dom-if" if="{{isSubmitOrder}}">


          user-list
          <a name="placeorder" href="[[rootPath]]placeorder">Submit Order</a>
          </template>
        </iron-selector>
        </app-drawer>
        ...
        <app-header-layout has-scrolling-region="">
          <app-header slot="header" condenses="" reveals="" effects="waterfall">
            <app-toolbar>
              ...
              <div main-title="">Online Trading  App</div>
          ...
          <iron-pages selected="[[page]]" attr-for-selected="name" role="main"  >
           <!-- <dashboard-element name="dashboard"></dashboard-element>-->
            <itempurchase-element name="placeorder"></itempurchase-element>
            <user-list name="profile"></user-list>
  ...
  _routePageChanged(page) {
   // alert(page);
    ...
    if (!page) {
      this.page = 'profile';
    } else if (['profile', 'placeorder' ].indexOf(page) !== -1) {
      this.page = page;
    } else {
  ...
  _pageChanged(page) {
   // alert('\n_pageChanged'+page);
    ...
    switch (page) {
      case 'profile':
        import('./my-userlist.js');
        break;
      case 'placeorder':
        import('./my-purchase.js');
        break;
